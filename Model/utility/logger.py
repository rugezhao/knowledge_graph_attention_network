...
from utility.constants import TEMP_FOLDER, GC_HOME

from utility.gc_storage import GCStorage, GCOpen
...
class Logger(object):
    ...
    def __init__(self, general_log_path, outputs_folder):
        ...
        self.summary_writer = SummaryWriter(log_dir=TEMP_FOLDER,
